...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <motion.div
      className="group relative bg-gradient-to-br from-gray-800/40 to-gray-900/60 rounded-2xl border border-gray-700/40 backdrop-blur-md overflow-hidden hover:border-gray-500/60 transition-all duration-500 hover:shadow-[0_0_40px_rgba(255,255,255,0.08)]"
        ...
        <div className={`p-5 lg:p-6 flex flex-col ${isMobile ? 'lg:w-1/2' : 'w-full'}`}>
          ...
          <div className="mt-auto pt-2">
            <div className="flex flex-wrap gap-2">
              ...
              {project.liveUrl && (
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white text-sm font-semibold rounded-xl transition-all duration-300 hover:shadow-[0_0_20px_rgba(59,130,246,0.4)]"
                >
              ...
              {project.githubUrlFrontend && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-3 py-2 bg-gray-700/50 hover:bg-gray-600/50 text-white text-sm font-medium rounded-xl border border-gray-600/40 hover:border-gray-500/60 transition-all duration-300"
                >
            ...
            {!project.liveUrl && !project.githubUrlFrontend && !project.githubUrlBackend && (
              <p className="text-xs text-gray-500 text-center italic mt-2 p-4 pb-8">
